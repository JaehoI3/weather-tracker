...
#What is the current temperature now at this location?
...
temp_c = current_temp
temp_f = round((9*temp_c)/5 +32,1)
today = date.today()
log_df = pd.DataFrame({'date':[str(today)],'temp_f': [temp_f], 'time':[current_time],'temperature_2m':[current_temp]})
